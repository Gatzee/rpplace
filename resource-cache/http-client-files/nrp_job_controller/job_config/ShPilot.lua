JOB_DATA[ JOB_CLASS_PILOT ] =
{
    ...
    marker_postions = 
    {
    	{ city = 1,  name = "Лётчик: компания",  x = -2525.676, y = 256.522, z = 16.659, }
    },
    ...
    {
        {
            ...
            on_end_shift = function( player )
                ...
                if isElement( quest_vehicle ) and player.vehicle == quest_vehicle then
                    ...
                    local respawn_position = Vector3( -2477.332, 254.480, 15.250 )
    ...
    vehicle_position =
    {
        [ 1 ] =
        {
            pilot_company_1 = 
            {
                ...
                positions =
                {
                    { position = Vector3( -2518.581, 534.943, 16 ), rotation = Vector3( 0, 0, 145 ) },
                    { position = Vector3( -2501.483, 524.469, 16 ), rotation = Vector3( 0, 0, 145 ) },
                    { position = Vector3( -2479.783, 512.668, 16 ), rotation = Vector3( 0, 0, 145 ) },
                    { position = Vector3( -2477.431, 481.469, 16 ), rotation = Vector3( 0, 0, 55 ) },
                },
            },
            ...
            pilot_company_3 = 
            {
                ...
                positions =
                {
                    { position = Vector3( -2698.095, 376.614, 16 ), rotation = Vector3( 0, 0, 330 ) },
                    { position = Vector3( -2657.634, 359.336, 16 ), rotation = Vector3( 0, 0, 330 ) },
                    { position = Vector3( -2663.038, 467.9, 16 ), rotation = Vector3( 0, 0, 130 ) },
                    { position = Vector3( -2634.951, 447.663, 16 ), rotation = Vector3( 0, 0, 130 ) },
                },
            },
        }
    },
