QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2376.738, -243.317 + 860, 20.249 ), function()
						CEs.marker:destroy()
		...
		[3] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -375.747, -1672.428 + 860, 21.107 ), "training_military_delivery_pilot_end_step_3", _, 4, 0, 0 )
		...
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -354.786, -1665.647 + 860, 22.379 ), function()
						CEs.marker:destroy()
		...
		[5] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 330.328, -2020.938 + 860, 21.570 ), "training_military_delivery_pilot_end_step_5", _, 4, 0, 0 )
		...
		[6] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 338.013, -2039.714 + 860, 21.819 ), function()
						CEs.marker:destroy()
		...
		[7] = {
			...
			Setup = {
				client = function( data )
					...
					CreateQuestPoint( Vector3( 2191.393, -616.025 + 860, 61.309 ), "training_military_delivery_pilot_end_step_7", _, 4, 0, 0 )
		...
		[8] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 2204.945, -602.827 + 860, 61.590 ), function()
						CEs.marker:destroy()
		...
		[9] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1945.128, -704.913 + 860, 61.379 ), "training_military_delivery_pilot_end_step_9", _, 4, 0, 0 )
		...
		[10] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1958.176, -728.031 + 860, 61.267 ), function()
						CEs.marker:destroy()
		...
		[11] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2284.648, -18.218 + 860, 20.695 ), "training_military_delivery_pilot_end_step_11", _, 4, 0, 0, CheckPlayerMilitaryVehicle )
