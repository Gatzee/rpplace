...
function getVehicleOriginalParameters( self )  -- Временно сделал
	return 100, 100, 100
end
...
Vehicle.ApplyHeightLevel = function( self, level )
	...
	-- setVehicleHeightLevel( self, ( offsets[ level ] and ( default_value + offsets[ level ] ) or 0 ), upper_limits[ level ] or 0 )  -- У нас нет такой функции
