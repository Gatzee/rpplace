...
QUESTS_NPC = {
	[5] = {
		...
		player_position = Vector3( 1965.7386474609 + 860, -245.71063232422, 60.437831878662 ),
		player_rotation = 301,
	...
	[13] = {
		name = "Прапорщик",
		model = 126,
		position = Vector3(-2411.671, 781.708 + 860, 20.295),
		cam_position = Vector3(-2410.225, 781.744 + 860, 20.998),
		rotation = 260,
		dimension = URGENT_MILITARY_DIMENSION,
		point_position = Vector3( -2410.225, 781.744 + 860, 20 ),
		non_movable = true,
		anim = {"bar", "barcustom_loop"},
	},
	[14] = {
