...
DAILY_QUEST_LIST =
{
    ...
    ["np_visit_car_showroom"] = 
    {
        ...
        get_location = function( )
            local carsells_list = { }
            local carsell_categories = { "carsell_economy", "carsell_normal", "carsell_luxe", "carsell_premium" }
    ...
    ["np_visit_shipyard"] = 
    {
        ...
        get_location = function( )
            return { x = 1474.718, y = -2518.580 + 860, z = 2.170 }
        end,
        rewards = { value = 1, type = "hard", first_value = 2 } 
    },
    ...
    ["np_visit_church"] =
    {
        ...
        get_location = function( )
            return { x = 179.96, y = -1693.46 + 860, z = 22 }
        end,
        rewards = { value = 1000, type = "soft" }
    },
