...
CONST_PICKUP_POINTS = {
	Vector3( 1110.313, -2710.396 + 860, 21.845 );
	Vector3( 1073.104, -2720.818 + 860, 21.136 );
}
...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2510.885, 334.642 + 860, 16.023 ), "training_military_skydiving_heli_end_step_2", _, 2, 0, 0 )
				end;
			};
		};
		[3] = {
