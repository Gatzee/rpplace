...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -833.669, -1685.583 + 860, 20.867 ), "training_ambassador_delivery_s_armed_end_step_2", _, 20, 0, 0, CheckPlayerQuestVehicle )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2433.695, 282.641 + 860, 15.302 ), "training_ambassador_delivery_s_armed_end_step_3", _, 20, 0, 0, CheckPlayerQuestVehicle )
				end;
			};
		};
	};
