...
PRISON_ROOM_POSITIONS =
{
      [ 1 ] =
      {
		...
		rooms = {
            ...
            out_job_marker = Vector3( -2472.7041, 1848.1845 + 860, 14.0847 );

		release_positions =
		{
			{ x = -2647.7512, y = 1535.0034 + 860, z = 14.086, interior = 0, dimension = 0 },
		},
	},
      ...
      [ 2 ] =
	{
		...
		rooms = {
            ...
            out_job_marker = Vector3( -2382.9536, 1706.4189 + 860, 14.0858 );

		release_positions =
		{
			{ x = -2655.7512, y = 1538.0034 + 860, z = 14.086, interior = 0, dimension = 0 },
		},
    },
    ...
    [ 3 ] =
    {
		...
		rooms = {
            ...
            out_job_marker = Vector3( -2475.3625, 1645.9948 + 860, 14.0858 );

		release_positions =
		{
			{ x = -2640.7512, y = 1534.0034 + 860, z = 14.086, interior = 0, dimension = 0 },
		},
	},
}
...
POSITION_JOB_MARKERS =
{
      --Грузчик
      {
            position = Vector3( -2867.6640, 1864.7290 + 860, 14.0874 ),
            callback = function()
                  DestroyJobsMarkers()
      ...
      --Маляр, возле цеха 1
      {
            position = Vector3( -2791.5871, 1952.2368 + 860, 14.0942 ),
            callback = function()
                  DestroyJobsMarkers()
      ...
      --Маляр, возле цеха 2
      {
            position = Vector3( -2624.8728, 1928.9543 + 860, 14.0844 ),
            callback = function()
                  DestroyJobsMarkers()
                  triggerServerEvent( "PlayeStartQuest_task_jail_2", localPlayer )
            end,
      ...
      {
            position = Vector3( -2798.7717, 1933.5070 + 860, 15.5955 ),
      ...
      {
            position = Vector3( -2645.3210, 1923.6513 + 860, 15.3731 ),
            callback = function() end,
            dimension = 0,
            interior = 0,
            marker_text = "Сборщик деталей",
