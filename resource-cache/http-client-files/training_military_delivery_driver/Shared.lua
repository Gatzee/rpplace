QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2427.204, -251.69 + 860, 20.706 ), "training_military_delivery_driver_end_step_2", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
				end;

				server = function( player, data )
					local vehicle = CreateTemporaryQuestVehicle( player, 433, -2416.278, -17.867 + 860, 20.699, 0, 0, 89.362 )
		...
		[3] = {
			...
			Setup = {
				server = function( player, data )
					CreateAmmoBoxTask( player, false, 40, Vector3( -2406.232, -252.212 + 860, 20.105 ), Vector3( -2416.191, -251.961 + 860, 20.105 ), 25, 3 )
				end;
			};
		...
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2284.648, -18.218 + 860, 20.695 ), "training_military_delivery_driver_end_step_4", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
				end;
			};
		};
		[5] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -375.747, -1672.428 + 860, 21.107 ), "training_military_delivery_driver_end_step_5", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
		...
		[6] = {
			...
			Setup = {
				server = function( player, data )
					CreateAmmoBoxTask( player, true, 10, Vector3( -362.873, -1665.364 + 860, 22.379 ), Vector3( -367.511, -1668.229 + 860, 20.852 ), 22, 6 )
				end;
			};
		...
		[7] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 330.328, -2020.938 + 860, 21.570 ), "training_military_delivery_driver_end_step_7", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
		...
		[8] = {
			...
			Setup = {
				server = function( player, data )
					CreateAmmoBoxTask( player, true, 10, Vector3( 317.559, -2034.848 + 860, 21.819 ), Vector3( 323.090, -2029.005 + 860, 20.972 ), 25, 8 )
				end;
			};
		...
		[9] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 539.927, -1222.431 + 860, 21.110 ), "training_military_delivery_driver_end_step_9", "marker_way_1", _, 0, 0, CheckPlayerMilitaryVehicle )
					CreateQuestPoint( Vector3( 842.294, -1931.299 + 860, 21.430 ), "training_military_delivery_driver_end_step_9", "marker_way_2", _, 0, 0, CheckPlayerMilitaryVehicle )
		...
		[10] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1550.146, -669.573 + 860, 41.541 ), "training_military_delivery_driver_end_step_10", "marker_way_1", _, 0, 0, CheckPlayerMilitaryVehicle )
					CreateQuestPoint( Vector3( 1718.604, -1320.749 + 860, 34.930 ), "training_military_delivery_driver_end_step_10", "marker_way_2", _, 0, 0, CheckPlayerMilitaryVehicle )
					CEs.marker_way_1.slowdown_coefficient = nil
					CEs.marker_way_2.slowdown_coefficient = nil
		...
		[11] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 2191.393, -616.025 + 860, 61.309 ), "training_military_delivery_driver_end_step_11", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
		...
		[12] = {
			...
			Setup = {
				server = function( player, data )
					CreateAmmoBoxTask( player, true, 10, Vector3( 2207.380, -605.714 + 860, 61.584 ), Vector3( 2201.002, -612.917 + 860, 60.824 ), 25, 12 )
				end;
			};
		...
		[13] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1945.128, -704.913 + 860, 61.379 ), "training_military_delivery_driver_end_step_13", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
		...
		[14] = {
			...
			Setup = {
				server = function( player, data )
					CreateAmmoBoxTask( player, true, 10, Vector3( 1956.341, -725.912 + 860, 61.470 ), Vector3( 1951.696, -716.113 + 860, 60.784 ), 20, 14 )
				end;
			};
		...
		[15] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2284.648, -18.218 + 860, 20.695 ), "training_military_delivery_driver_end_step_15", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
