...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2510.885, 334.642 + 860, 16.023 ), "training_military_skydiving_aircraft_end_step_2", _, 2, 0, 0 )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				...
				server = function( player, data )
					local vehicle = CreateTemporaryQuestVehicle( player, 592, -2586.595, 380.538 + 860, 16.480, 0, 0, 58 )
		...
		[5] = {
			...
			Setup = {
				...
				server = function( player, data )
					...
					local enter_marker = createMarker( Vector3( -2570.113, 370.167 + 860, 14.304 ), "cylinder", 1.5, 100, 250, 100, 150 )
		...
		[7] = {
			...
			Setup = {
				client = function( data )
					CEs.checkpoint = TeleportPoint( { x = 318.751, y = -2587.506 + 860, z = 600, radius = 30, gps = true, keypress = false } )
			...
			CleanUp = {
				server = function( player, data, failed )
					if failed then
						player.position = Vector3( -2500.613, 328.088 + 860, 15.303 ) + Vector3( math.random( -5, 5 ), math.random( -5, 5 ), 0 )
					end
				end;
			};
		};
		...
		[9] = {
			...
			Setup = {
				client = function( data )
					...
					CreateQuestPoint( Vector3( -2586.595, 380.538 + 860, 16.480 ), "training_military_skydiving_aircraft_end_step_9", _, 6, 0, 0, CheckPlayerInAircraft )
				end;
