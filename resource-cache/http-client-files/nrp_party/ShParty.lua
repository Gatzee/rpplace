...
REWARDS_LIST = {
    {
        ...
        rewards = {
            ...
            { type = "vehicle", id = 420,       cost = 1100000,    places = { 1, 1 },                                 },
        },
    },
    {
        requirement = 50,
    ...
    },
    {
        ...
        rewards = {
            ...
            { type = "vehicle",     cost = 4500000,     places = { 2, 3 },      id = 479                                  },
            { type = "vehicle",     cost = 39900000,    places = { 1, 1 },      id = 527                                  },
        },
    },
    {
        requirement = 200,
        rewards = {
            ...
            { type = "vehicle",     cost = 6000000,     places = { 2, 3 },      id = 518                                    },
