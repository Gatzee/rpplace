...
Player.EnterOnUrgentMilitaryBase = function( self )
	self.position = Vector3( -2372.944, -113.476, 21 ) + Vector3( math.random( -3, 3 ), math.random( -3, 3 ), 0 )
...
Player.ExitFromUrgentMilitaryBase = function( self )
	...
	self.interior = 0
	self.dimension = 0
	self.position = Vector3( -1217.257, -1285.566, 21.428 ) + Vector3( math.random( -2, 2 ), math.random( -2, 2 ), 0 )
