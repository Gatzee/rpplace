...
LOTTERIES_INFO = {
    ...
    theme_1 = {
        ...
        name = "Супергеройский",
        start_ts  = getTimestampFromString( "01.01.2025" ),
        finish_ts = getTimestampFromString( "01.01.2030" ),
    },
    theme_2 = {
        type = "theme",
    ...
    theme_27 = {
        ...
        analytics_name = "hype",
        name = "Хайповая",
        start_ts  = getTimestampFromString( "28.11.2021" ),
        finish_ts = getTimestampFromString( "28.12.2021" ),
    },
    theme_28 = {
        type = "theme",
