...
COMMAND_ACCESS_LEVELS = {
	...
	[ 'setmayor' ] =            { ACCESS_LEVEL_SUPERVISOR, "/setmayor <мэрия> <id> - Назначить игрока Мэром города (7 - Новороссийск, 8 - Горки)" },
    [ 'removemayor' ] =         { ACCESS_LEVEL_SUPERVISOR, "/removemayor <мэрия> <причина> - Снять мэра города (7 - Новороссийск, 8 - Горки)" },
    [ 'reseteconomy' ] =        { ACCESS_LEVEL_SUPERVISOR, "/reseteconomy <мэрия> - Сбросить настройки экономики (7 - Новороссийск, 8 - Горки)" },
    [ 'startvoting' ] =         { ACCESS_LEVEL_SUPERVISOR, "/startvoting <мэрия> - Начать досрочные выборы (7 - Новороссийск, 8 - Горки)" },
	...
	[ "youtuber" ] =    ACCESS_LEVEL_DEVELOPER,
