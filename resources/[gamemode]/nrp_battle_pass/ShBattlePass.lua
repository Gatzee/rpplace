...
BP_STAGES = {
    { tasks_count = 10, start_ts = getTimestampFromString( "26.11.2021 00:00" ) },
    { tasks_count = 10, start_ts = getTimestampFromString( "03.12.2021 00:00" ) },
    { tasks_count = 10, start_ts = getTimestampFromString( "10.12.2021 00:00" ) },
    { tasks_count = 10, start_ts = getTimestampFromString( "17.12.2021 00:00" ) },
}
