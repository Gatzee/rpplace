...
-- Авторизация
OLD_AUTH_SUPPORTED_UNTIL = getTimestampFromString( "2 июля 2020 00:00" ) -- когда старая авторизация превратится в тыкву
...
--------------------------- STAGE 0
-- Загрузка файлов
--[[  CAMERA_LOCATIONS = {  -- Смысла нет только добавляет очистку
...
function OnPlayerJoin( )
	...
	spawnPlayer( player, 187.01307678223, -1500.9643554688, 0, 0, 0, 0, math.random( 65534 ) )
	setCameraMatrix( player, 264.17254638672, -1563.5985107422, 51.35559463501, 187.01307678223, -1500.9643554688, 40.247985839844, 0, 70 )
