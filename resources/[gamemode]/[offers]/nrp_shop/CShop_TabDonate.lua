        ...
        for i, v in pairs( packs ) do
            ...
            ibCreateArea( npx, npy, 149, 155, parent )
                ...
                :ibOnClick( function( key, state )
                    ...
                    ibClick( )
                    ShowPaymentForPrice( v )
					SendElasticGameEvent( "f4r_f4_currency_deposit_button_click", { button = "proposed", hard = v } )
                end )
        ...
        do
            ...
            hover
                ...
                :ibOnClick( function( key, state )
                    ...
                    ShowPaymentForPrice( amount )
					SendElasticGameEvent( "f4r_f4_currency_deposit_button_click", { button = "custom", hard = amount } )
                end )
        end
        ------------------------
        --     Промокоды      --
