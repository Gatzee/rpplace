...
CONST_START_POINTS = {
	Vector3( -2555.406, 426.377 + 860, 16.944 );
	Vector3( -2528.498, 474.942 + 860, 16.891 );
}

CONST_PICKUP_POINTS = {
	Vector3( 1133.390, -2680.655 + 860, 21.671 );
	Vector3( 1096.529, -2716.177 + 860, 21.410 );
}
...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2510.885, 334.642 + 860, 16.023 ), "training_military_skydiving_s_skydiver_end_step_2", _, 2, 0, 0 )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2586.595, 380.538 + 860, 16.480 ), "training_military_skydiving_s_skydiver_end_step_3", _, 35, 0, 0 )
				end;
		...
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1051.762, -2556.875 + 860, 31.581 ), "training_military_skydiving_s_skydiver_end_step_4", _, 10, 0, 0 )
				end;
			};
