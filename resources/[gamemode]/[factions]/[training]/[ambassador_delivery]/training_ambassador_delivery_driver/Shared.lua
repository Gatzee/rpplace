...
CONST_CITY_ROUTE = {
	Vector3( 496.846, -2336.58 + 860, 20.836 ),
	Vector3( 482.93, -2319.658 + 860, 20.839 ),
	Vector3( 248.346, -2319.729 + 860, 20.845 ),
	Vector3( 232.777, -2291.964 + 860, 20.833 ),
	Vector3( 249.813, -1954.224 + 860, 20.836 ),
	Vector3( 223.596, -1925.122 + 860, 20.837 ),
	Vector3( -851.615, -1944.681 + 860, 20.871 ),
	Vector3( -868.299, -1927.634 + 860, 20.878 ),
	Vector3( -833.669, -1685.583 + 860, 20.867 ),
}
...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 495.055, -2365.123 + 860, 20.800 ), "training_ambassador_delivery_driver_end_step_2", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				...
				server = function( player, data )
					local vehicle = CreateTemporaryQuestVehicle( player, 445, 498.998, -2364.863 + 860, 20.832, 0, 0, 0 )
		...
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2481.924, 361.143 + 860, 15.389 ), "training_ambassador_delivery_driver_end_step_4", _, 10, 0, 0, CheckPlayerQuestVehicle )
				end;
