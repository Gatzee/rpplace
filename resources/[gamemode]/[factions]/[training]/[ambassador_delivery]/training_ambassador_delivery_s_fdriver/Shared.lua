...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 495.055, -2365.123 + 860, 20.800 ), "training_ambassador_delivery_s_fdriver_end_step_2", _, 2, 0, 0, CheckPlayerMilitaryVehicle )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				client = function( data )
					...
					CreateQuestPoint( Vector3( -833.669, -1685.583 + 860, 20.867 ), "training_ambassador_delivery_s_fdriver_end_step_3", _, 10, 0, 0, CheckPlayerMilitaryVehicle )
				end;

				server = function( player, data )
					local vehicle = CreateTemporaryQuestVehicle( player, 445,  499.012, -2376.463 + 860, 20.832, 0, 0, 0 )
		...
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2481.924, 361.143 + 860, 15.389 ), "training_ambassador_delivery_s_fdriver_end_step_4", _, 10, 0, 0, CheckPlayerQuestVehicle )
				end;
			};
