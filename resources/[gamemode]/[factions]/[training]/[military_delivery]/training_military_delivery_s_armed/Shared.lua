QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2427.204, -251.69 + 860, 20.706 ), "training_military_delivery_s_armed_end_step_2", _, 8, 0, 0 )
				end;
			};
		};
		[3] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -375.747, -1672.428 + 860, 21.107 ), "training_military_delivery_s_armed_end_step_3", _, 8, 0, 0 )
				end;
			};
		};
		[4] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 330.328, -2020.938 + 860, 21.570 ), "training_military_delivery_s_armed_end_step_4", _, 8, 0, 0 )
				end;
			};
		};
		[5] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 2191.393, -616.025 + 860, 61.309 ), "training_military_delivery_s_armed_end_step_5", _, 8, 0, 0 )
				end;
			};
		};
		[6] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( 1956.341, -725.912 + 860, 61.470 ), "training_military_delivery_s_armed_end_step_6", _, 8, 0, 0 )
				end;
			};
		};
		[7] = {
			...
			Setup = {
				client = function( data )
					CreateQuestPoint( Vector3( -2284.648, -18.218 + 860, 20.695 ), "training_military_delivery_s_armed_end_step_7", _, 8, 0, 0 )
				end;
			};
		};
	};
