        ...
        [ 0 ] = 
        {
            [ DEFAULT_COMPANY_VEHICLE ] =
            {
                ...
                positions =
                {
                    ...
                    { position = Vector3( 480, -2195, 20.4 ), rotation = Vector3( 0, 0, 135 ) },
                    { position = Vector3( 476, -2195, 20.4 ), rotation = Vector3( 0, 0, 135 ) },
                    { position = Vector3( 472, -2195, 20.4 ), rotation = Vector3( 0, 0, 135 ) },
        ...
        [ 1 ] = 
        {
            [ DEFAULT_COMPANY_VEHICLE ] =
            {
                ...
                positions =
                {
                    ...
                    { position = Vector3( 1753.4, -548.6000 + 8601, 60.5 ), rotation = Vector3( 0, 0, 264 ) },
