...
CENTER_WOOD_POINT = Vector3( 1866.3865, 333.7227, 16.5139 )
...
STOCK =
{
	{ 
		...
		take_position =  
		{
			Vector3( 1902.6124, 211.0635, 16.5139 ),
			Vector3( 1899.7131, 212.111, 16.5139 ),
			Vector3( 1896.6618, 213.6472, 16.5139 ),
		},
	},
	{
		name = "stock_2_bunch_1", 
		...
		take_position =  
		{
			Vector3( 1740.9501, 276.1472, 16.5139 ),
			Vector3( 1737.2283, 276.7274, 16.5139 ),
			Vector3( 1734.7884, 277.43, 16.5139 ),
		},
	},
	{
		name = "stock_2_bunch_1",
		...
		take_position =  
		{
			Vector3( 1891.0637, 447.4951, 16.5139 ),
			Vector3( 1894.0781, 449.0631, 16.5139 ),
			Vector3( 1897.5255, 450.4594, 16.5139 ),
		},
	},
}
...
{
	{ 
		position = Vector3( 1794.9725, 236.6464, 16.5139 ),
		process_position = Vector3( 1792.6795, 238.5364, 16.5139 ),
		stock_sawmill = Vector3( 1793.4959, 230.5417, 17.0143 ),
		stock_result = Vector3( 1918.4749, 292.1164, 16.5139 ),
	},
	{ 
		position = Vector3( 1984.1750, 451.348, 16.5139 ),
		process_position = Vector3( 1989.5798, 448.4903, 16.5139 ),
		stock_sawmill = Vector3( 1992.8850, 447.7646, 17.0435 ),
		stock_result = Vector3( 1932.0267, 291.6372, 16.5139 ),
	},
}
