...
{
	{
		...
		position = Vector3( 1743.5664, 100.0573, 14.6375 ),
		places =
		{
			Vector3( 1749.4061, 88.6401, 13.6342 ),
			Vector3( 1749.4061, 88.6401, 13.6342 ),
			Vector3( 1736.52, 85.2954, 13.1992 ),
			Vector3( 1727.0145, 94.5973, 13.5961 ),
			Vector3( 1719.5971, 101.4762, 13.8774 ),
			Vector3( 1726.6206, 112.0133, 14.8892 ),
			Vector3( 1741.9426, 113.6284, 15.4536 ),
			Vector3( 1738.4063, 123.8734, 15.9366 ),
			Vector3( 1762.1289, 102.9462, 15.3468 ),
			Vector3( 1764.4033, 84.4435, 13.8706 ),
		},
	},

	{
		...
		places =
		{
			Vector3( 2028.0042, 321.3172, 16.3889 ),
			Vector3( 2029.2133, 335.5551, 16.3889 ),
			Vector3( 2036.8216, 340.9422, 16.8343 ),
			Vector3( 2023.5267, 321.2708, 16.3889 ),
			Vector3( 2024.5053, 309.191, 16.638 ),
			Vector3( 2015.8726, 302.3913, 16.8514 ),
			Vector3( 2006.0111, 309.82, 16.9592 ),
			Vector3( 2001.3458, 323.3999, 17.8542 ),
			Vector3( 2000.775, 334.9709, 18.4237 ),
			Vector3( 2004.8297, 344.4835, 18.862 ),
		},
	},

	{
		...
		places =
		{
			Vector3( 1789.6712, 552.5985, 17.354 ),
			Vector3( 1788.8122, 540.7562, 17.332 ),
			Vector3( 1779.2497, 536.1091, 16.2178 ),
			Vector3( 1769.3662, 527.0639, 15.8614 ),
			Vector3( 1757.064, 534.014, 15.8614 ),
			Vector3( 1751.5917, 543.8809, 15.8614 ),
			Vector3( 1757.1822, 551.005, 16.0479 ),
			Vector3( 1762.0557, 562.5894, 16.6986 ),
			Vector3( 1774.8151, 568.0369, 17.2008 ),
			Vector3( 1791.8509, 563.3439, 17.1184 ),
		},
	},

	{
		...
		places =
		{
			Vector3( 1684.4786, 427.8706, 20.2073 ),
			Vector3( 1686.2791, 436.5791, 19.3342 ),
			Vector3( 1691.9385, 416.7017, 19.9637 ),
			Vector3( 1685.9346, 407.1132, 19.7624 ),
			Vector3( 1672.3391, 405.9141, 19.0425 ),
			Vector3( 1665.2893, 418.1074, 19.2831 ),
			Vector3( 1659.5721, 403.8704, 18.3983 ),
			Vector3( 1676.0224, 392.7728, 18.3421 ),
			Vector3( 1694.9251, 400.1236, 19.4974 ),
			Vector3( 1707.8625, 407.3685, 18.8663 ),
		},
	},
}
...
{
	{
		...
		position = Vector3( 1896.0781, 204.7639, 15.9221 ),
	},
	{
		name = "stock_2_bunch_1", 
		position = Vector3( 1736.4838, 268.1252, 15.9221 ),
	},
	{
		name = "stock_2_bunch_1", 
		position = Vector3( 1890.9644, 456.3127, 15.9221 ),
	},
}
